...
STEREOMODE	equ 0				;0 EQU> compile RMTplayer for mono 4 tracks
;
	icl "music/rmtplayr.a65"			;include RMT player routine
;
;
	opt h-						;RMT module is standard Atari binary file already
	ins "music/music.rmt"				;include music RMT module
	opt h+
...
player0 DTA 0,0,0,0,0,0,0,0
		DTA 0,0,128,128,192,231,255,255
		DTA 127,63,31,15,7,6,4,6
player1 DTA 0,0,0,7,15,27,31,31
		DTA 31,28,63,124,252,255,253,252
		DTA 248,248,240,224,96,32,32,48
player2 DTA 0,0,0,224,240,240,240,240
		DTA 240,0,224,0,0,0,0,0
		DTA 0,0,0,0,0,0,0,0

cactus1 DTA 0,0,0,48,48,50,50,178,190,176,240,48,48,48,48,48
cactus2 DTA 0,0,0,24,26,26,26,94,88,88,88,120,24,24,24,24
cactus3 DTA 0,0,26,26,90,90,90,94,88,120,24,24,24,24,24,24

fence 	DTA d"--------------------",$9B
c1 		DTA 13+130,13+131,$9B
c2 		DTA 13+128,13+129,$9B
c3 		DTA 13+132,13+133,$9B
clr 	DTA d" ",$9B

blanks	DTA d"                    ",$9B

jumpseq	DTA 4,8,16,24,24,16,8,4,0
NAME    DTA c"S:",$9B
;NAME   DTA $53,$3A,$9B
