...
for k=-20000 to 20000 step 10

a=3*k/45000 + sin(17*PI/20*pow(k/20000,5)) * pow(cos(41*PI*k/20000),6) + (1/3*pow(cos(41*PI*l/20000) ,16) + 1/3*pow(cos(41*PI*k/20000),80) )*pow(cos(PI*k/40000),12)*sin(6*PI*k/20000)
